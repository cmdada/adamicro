...
GOVARS = -X github.com/cmdada/adamicro/v2/internal/util.Version=$(VERSION) -X github.com/cmdada/adamicro/v2/internal/util.CommitHash=$(HASH) -X 'github.com/cmdada/adamicro/v2/internal/util.CompileDate=$(DATE)'
DEBUGVAR = -X github.com/cmdada/adamicro/v2/internal/util.Debug=ON
